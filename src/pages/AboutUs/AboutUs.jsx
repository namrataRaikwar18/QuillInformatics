...
import { BackToHome, FunFactCard } from "../../Components";
    ...
    <>
      <main className="aboutUsMain displayFlex">
        <section className="pageSection">
          ...
          <div className="imgText aboutImgTextContainer displayFlex pagePadding">
            <div>
              <BackToHome page="ABOUT US" />
            </div>
            <div>
        ...
        <div className="aboutBody greyText displayFlex pagePadding">
          <p className="bigText">
            <span className="primaryColorText">EMPOWERING ENTERPRISES</span>
            TODAY TO CATALYZE TOMORROW’S CHANGE!
          </p>
          ...
          <p>
            <small>
              <em>
                ...
                fuels up Intelligent businesses with Tech Intellect!"
              </em>
            </small>
          </p>
          <p className="lineHeight">
            <small>
              <span className="boldText"> Our team </span> consists of Brilliant
              minds who are highly proficient and well-informed IT professionals
              working with the common goal of presenting perfected solutions
              with potential efforts. The company works as a transformative
              partner serving native and overseas.
              <span className="boldText"> clients </span> in countries such as
              Germany, the US, Australia, Dubai, the UK and neighbouring
              countries.
            </small>
          </p>
        </div>
          ...
          <div className="aboutImg2Text lineHeight">
            ...
            <em>
              ...
              <p className="whiteText">
                We work on our motto
                <span className="boldText primaryColorText">
                  Inspect|
                  <span className="whiteText"> Adapt</span> |Deliver
                </span>
              </p>
            </em>
          </div>
        ...
        <div className="pagePadding coreValueContainer displayFlex greyText lineHeight">
          ...
          <p>
            The vision of dominating the globe with quality comes to life with a
            sense of rectitude, receptiveness, mutual respect and discipline
            that tecHindustan team upholds.
          </p>
          <ul className="coreValuesPoints">
            <h3 className="primaryColorText">Our Achievements:</h3>
            <div className="whiteDivider"></div>
            <li>
              Keeping the vision of leading the digital world we hold a grasp of
              clients overseas by serving 15+ countries worldwide.
            </li>
            <li>
              We are one of the leading tech solutions providers in the suburb.
            </li>
          ...
          <ul className="coreValuesPoints">
            ...
            <div className="whiteDivider"></div>
            <li>
              Our motto is to deliver prominent Business Solutions with
              innovative approaches like never seen before.
            </li>
            <li>
              To accelerate the change for future generations, we are ardent to
              contribute to tech evolution.
            </li>
          ...
          <div className="funFactContainer displayFlex">
            ...
            <div className="funFactCardContainer displayFlex">
              <FunFactCard
                icon={<FaStarOfLife />}
                quantity="74000+"
                about="CODE LINES THIS MONTH"
              />
              <FunFactCard
                icon={<RiPlaneFill />}
                quantity="700+"
                about="CRAFTED PROJECTS"
              />
              <FunFactCard
                icon={<CgSandClock />}
                quantity="12000+"
                about="CHAI CUPS THIS YEAR"
              />
              <FunFactCard
                icon={<ImBookmark />}
                quantity="60+"
          ...
          <p>
            Hire us today to avail your very own Product or Website at
            reckon-able rates.
          </p>
        </div>
      </main>
